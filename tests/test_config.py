...
DEFAULT: dict[str, dict[str, Any]] = {
    'run': {'M0a': 1, 'T1f': 1, 'T2f': 0.1, 'R': 10, 'poolBound_lineshapeAsymmetry': -593.83, 'M0b': 0.1, 'T1b': 1, 'T1D': 0.01, 'T2b': 1e-05, 'pw': 0.001, 'dt': 0.0015, 'es': 0.006, 'tr': 3, 'turbo': 80, 'N_dummyADC': 3, 'np': 4, 'nb': 10, 'btr': 0.1, 'btrlast': 0.001, 'fa_sat': 200, 'fa_rage': 5, 'FLAG_Signal': 'ALL', 'N_altern': 1, 'r_tukey': 0.3, 'outputDir': './output/', 'filePrefix': '', 'export': True, 'offset': 7000, 'export_read': True, 'output_fullVector': True},
