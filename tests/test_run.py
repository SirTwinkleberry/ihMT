...
CONFIG_SIMULATOR = {
    ...
    'compute': {
        'ihMTR_CM':  dict(
            ...
            MTs_Positive=[0.7676252471373343, 0.045410921774251135, 1.5267492098706718e-06, 1.0],
            MTs_Negative=[0.7676252471373343, 0.045410921774251135, 1.5267492098706718e-06, 1.0],
            MTd_CM=[0.6599520020621817, 0.01020810251790405, 0.0, 1.0],
        ),
        'ihMTR_ALT': dict(
            MT0=[0.9037829677605914, 0.09037837084448297, 0.0, 1.0],
            MTs_Positive=[0.7676252471373343, 0.045410921774251135, 1.5267492098706718e-06, 1.0],
            MTs_Negative=[0.7676252471373343, 0.045410921774251135, 1.5267492098706718e-06, 1.0],
            MTd_ALT=[0.6700713853511817, 0.013280082599358211, -2.7246881057072416e-07, 1.0],
        ),
        'BPR':  dict(
            MT0=[0.9037829677605914, 0.09037837084448297, 0.0, 1.0],
            MTd_ALT=[0.6700713853511817, 0.013280082599358211, -2.7246881057072416e-07, 1.0],
